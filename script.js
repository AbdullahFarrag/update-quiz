...
const correctSound = document.getElementById("udCorrect");
const wrongSound = document.getElementById("udWrong");
let timer;
...
function checkAnswer(selectedOption) {
  ...
  // Immediately apply styling and play sound based on correctness
